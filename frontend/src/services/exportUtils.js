...
export const EXPORT_COLUMNS = {
    ...
    cellphoneReport: [
        ...
        { label: 'Device Cost', accessor: r => r.device_cost ? Number(r.device_cost).toFixed(2) : '' },
        { label: 'Monthly Cost', accessor: r => r.monthly_cost ? Number(r.monthly_cost).toFixed(2) : '' },
        { label: 'Network', accessor: 'network_provider' },
